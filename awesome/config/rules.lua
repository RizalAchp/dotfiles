...
local function tagname(idx)
    return Beautiful.tagnames[idx]
end
...
local rules = function(cfg)
    return {
        ...
        { rule_any = { role = { 'browser' } }, properties = { tag = tagname(2), switchtotag = true } },
        -- Thunar
        { rule = { class = 'Thunar' },         properties = { tag = tagname(3), switchtotag = true } },
        -- KiCad
