...
-- function signals.on_titlebars(c)
...
function signals:init()
  ...
  client.connect_signal('manage', self.on_manage)
  -- Add a titlebar if titlebars_enabled is set to true in the rules.
  -- client.connect_signal('request::titlebars', self.on_titlebars)
