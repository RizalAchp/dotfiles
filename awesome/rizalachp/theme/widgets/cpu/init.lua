...
local WIDGET_DIR = ConfigWidgetDir .. '/cpu'
          ...
          if is_update == true then
            ...
            Awful.tooltip({
              ...
              timer_function = function()
                local text = cmd
                if process_info_max_length > 0 and text:len() > process_info_max_length then text = text:sub(0, process_info_max_length - 3) .. '...' end
