...
_G.ConfigWidgetDir = Gears.filesystem.get_configuration_dir() .. '/rizalachp/theme/widgets'

local dpi = Beautiful.xresources.apply_dpi
local theme = {}
theme.dir = Gears.filesystem.get_configuration_dir() .. '/rizalachp/theme'
...
theme.cpu_widget = require('rizalachp.theme.widgets.cpu')
theme.ram_widget = require('rizalachp.theme.widgets.ram')
theme.net_speed_widget = require('rizalachp.theme.widgets.net-speed')
theme.bluelight_widget = require('rizalachp.theme.widgets.bluelight')
theme.backlight_widget = require('rizalachp.theme.widgets.brightness')

local sep = require('rizalachp.theme.widgets.separators')
